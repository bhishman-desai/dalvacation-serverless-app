...
const dummyRooms = [
    ...
    },
    {
        ...
        feedbackPolarity: 'Positive',
        imageUrl: 'https://images.pexels.com/photos/206434/pexels-photo-206434.jpeg',
    },
    {
        id: 4,
    ...
    },
    {
        ...
        feedbackPolarity: 'Positive',
        imageUrl: 'https://images.pexels.com/photos/276671/pexels-photo-276671.jpeg',
    },
    {
        id: 10,
        ...
        feedbackPolarity: 'Positive',
        imageUrl: 'https://www.shutterstock.com/image-illustration/luxury-presidential-suite-bedroom-large-260nw-1237191433.jpg',
    }
];
        ...
        <Container>
            ...
            <Grid container spacing={2} alignItems="center" justifyContent="center" sx={{ minHeight: 'calc(100vh - 64px)', width: '100%' }}>
                ...
                <Box justifyContent={"space-evenly"}>
                    ...
                    - Affordable pricing
                    <br />
                    - Beautiful locations and breathtaking views
                    </Typography>
                </Box>
            </Grid>
            ...
            <Box sx={{ overflowX: 'auto', display: 'flex', gap: 2, py: 2 }}>
                {dummyRooms.map((room) => (
                    <Card key={room.id} sx={{ minWidth: 300 }}>
                        <CardMedia component="img" height="200" image={room.imageUrl} alt={room.name} />
                        <CardContent>
                            <Typography variant="h5" gutterBottom>{room.name}</Typography>
                            <Typography variant="body1" gutterBottom>Type: {room.type}</Typography>
                            <Typography variant="body1" gutterBottom>Availability: {room.availability ? 'Available' : 'Not Available'}</Typography>
                            <Typography variant="body1" gutterBottom>Tariff: ${room.tariff} per night</Typography>
                            <Typography variant="body2" gutterBottom>Feedback: {room.feedback}</Typography>
                        </CardContent>
                    </Card>
                ))}
            </Box>
            ...
            <Grid container spacing={2} justifyContent="center">
                {companyLogos.map((logo, index) => (
                    <Grid item key={index}>
                        <img src={logo} alt={`Company logo ${index + 1}`} style={{ width: 150, height: 150 }} />
                    </Grid>
                ))}
            </Grid>
        </Container>
